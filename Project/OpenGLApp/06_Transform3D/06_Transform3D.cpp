...
FuncStruct Run_06_Transform3D()
{
	FuncStruct callback;
	callback.win_name = "06_Transform3D";
...
{   
    ...
    projection = glm::perspective(glm::radians(45.0f), (float)APP_WIDTH / (float)APP_HEIGHT, 0.1f, 100.0f);
